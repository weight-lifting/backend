...
describe('exercises model',() => {
    ...
    describe('add', () => {
        ...
        it("should insert a exercise into the db", async () => {
            ...
            await Exercises.add({ id: 0,title: "planks", reps_completed: 1 ,date:"2020-01-15",targeted_area:"neck",user_id:0})
            await Exercises.add({ id: 1,title: "planksss", reps_completed: 11,date:"2020-01-13",targeted_area:"brain",user_id:1})
        ...
        it("should return new exercise on insert", async () => {
            const exercise = await Exercises.add({ id: 1,title: "planks", reps_completed: 1,date:"2020-01-15",targeted_area:"neck",user_id:0})
            
            expect(exercise).toEqual({ id: 1,title: "planks", reps_completed: 1 ,date:"2020-01-15",targeted_area:"neck",user_id:0})
        })
    })
    ...
    describe("update", () => {
        ...
        it("updates specific exercises", async () => {
            ...
            const exercise_1 = {
                id: 0,title: "planks", reps_completed: 1 ,date:"2020-01-15",targeted_area:"neck",user_id:0
            }
            const exercise_2 = {
                id: 1,title: "planksss", reps_completed: 11,date:"2020-01-13",targeted_area:"brain",user_id:1
            }
